...
def create_RepVGG_A1(pretrained,deploy=False):
    model = RepVGG(num_blocks=[2, 4, 14, 1], num_classes=1000,
                  width_multiplier=[1, 1, 1, 2.5], override_groups_map=None, deploy=deploy)
    if pretrained:
        model.load_pretrained('./models/RepVGG-A1-train.pth')
    return model
...
def create_RepVGG_B1g2(pretrained, deploy=False):
    model =  RepVGG(num_blocks=[4, 6, 16, 1], num_classes=1000,
                  width_multiplier=[2, 2, 2, 4], override_groups_map=g2_map, deploy=deploy)
    if pretrained:
        model.load_pretrained('./models/RepVGG-B1g2-train.pth')
    return model
